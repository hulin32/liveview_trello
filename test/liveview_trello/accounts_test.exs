defmodule LiveviewTrello.AccountsTest do
  use LiveviewTrello.DataCase
  ...
  describe "users" do
    ...
    test "register_user/1 returns a user changeset" do
      user = user_fixture()
      assert %Ecto.Changeset{} = Accounts.register_user(user)
    end
  end
end
